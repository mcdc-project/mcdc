...
# Tally spatial filter types
SPATIAL_FILTER_NONE = 0
SPATIAL_FILTER_SURFACE = 1
SPATIAL_FILTER_CELL = 2
SPATIAL_FILTER_MESH = 3
...
PROTON_REACTION_NONELASTIC = 202
