...
@njit
def mgxs_nu_d_chunk(index_1, material, data):
...
@njit
def mgxs_chi_s_chunk(index_1, material, data):
...
@njit
def mgxs_chi_p_chunk(index_1, material, data):
...
@njit
def mgxs_chi_d_chunk(index_1, material, data):
