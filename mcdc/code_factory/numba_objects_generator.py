...
def generate_mcdc_access(targets):
    for object_name in targets.keys():
        ...
        #text_getter += "from mcdc.code_factory.jit import njit\n\n\n"
        #text_setter += "from mcdc.code_factory.jit import njit\n\n\n"
        ...
        for attribute in targets[object_name]:
            ...
            if len(shape) == 1:
                ...
                text_getter += _accessor_1d_all(object_name, attribute_name, shape[0], nb.types.float64)
