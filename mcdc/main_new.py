...
from mcdc.simulation import (
    simulation_fixed_source,
    simulation_eigenvalue,
)
...
def run():
    ...
    data, mcdc, data_new, mcdc_new = prepare()
    ...
    simulation = simulation_fixed_source
    if settings.eigenvalue_mode:
        simulation = simulation_eigenvalue

    # Run the simulation
    simulation(data, mcdc, data_new, mcdc_new)
...
def prepare():
    ...
    # TODO: adapt.set_toggle("iQMC", input_deck.technique["iQMC"])
