...
sx2 = mcdc.Surface.PlaneX(x=0.1, boundary_condition="vacuum")
sy1 = mcdc.Surface.PlaneY(y=0.0, boundary_condition="vacuum")
sy2 = mcdc.Surface.PlaneY(y=0.1, boundary_condition="vacuum")
sz1 = mcdc.Surface.PlaneZ(z=0.0, boundary_condition="vacuum")
sz2 = mcdc.Surface.PlaneZ(z=0.1, boundary_condition="vacuum")
...
range = 714.59 * 1e-4  # cm

bin_edges = range * percent_of_range * 1e-2

# mesh = mcdc.MeshUniform(x=(0.0, 0.002, 50))
...
mcdc.settings.N_particle = 10_000
