...
if reconstruct_2d:
    ...
    plt.tight_layout()
    plt.savefig(
        f"2D_sphere_recons_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}{bin_size_pixels}.png"
    )
    plt.show()

    # Plotting the relative errors
    plt.plot(l_array[2:], rel_errors[2:], label="Reconstruction Errors")
    plt.hlines(
    ...
    plt.title("Relative Error vs $\lambda$ - 2D Fissile Sphere Reconstructions")
    plt.legend()
    plt.tight_layout()
    plt.savefig(
        f"2D_sphere_errors_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}{bin_size_pixels}.png"
    )
    plt.show()
...
###########################################################
    ...
    plt.tight_layout()
    plt.savefig(
        f"3D_sphere_recons_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}{bin_size_pixels}.png"
    )
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(
        f"3D_sphere_errors_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}{bin_size_pixels}.png"
    )
    plt.show()
