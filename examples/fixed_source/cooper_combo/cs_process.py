...
if reconstruct_2d:
    ...
    plt.tight_layout()
    plt.savefig(f"2D_cooper_recons_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}.png")
    plt.show()
    ...
    plt.title("Relative Error vs $\lambda$ - 2D Modified Cooper Reconstructions")
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"2D_cooper_errors_{N_cs_bins}_{bin_size_pixels}{bin_size_pixels}.png")
    plt.show()
