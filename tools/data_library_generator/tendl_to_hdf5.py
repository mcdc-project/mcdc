...
"""
tendl_to_hdf5.py  —  Convert TENDL proton ACE files to HDF5 for MC/DC
...
Usage
-----
    python tendl_to_hdf5.py
    python tendl_to_hdf5.py --ace_dir /path/to/ace --output_dir /path/to/hdf5 [--pstar_dir /path/to/pstar]
    python tendl_to_hdf5.py ...  --rewrite   # overwrite existing files
    python tendl_to_hdf5.py ...  --verbose   # per-reaction detail
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert TENDL proton ACE files to MC/DC-compatible HDF5"
    )
    ...
    errors = []
    pbar   = tqdm(target_files, disable=args.verbose,
